...
module.exports = function(grunt) {
  ...
  var renameAll = function(done) {
    var renamePromises = [
      renameFile('build/Release-iphonesimulator/multi-touch-draw.app', 'build/Release-iphonesimulator/multi-touch-draw-iphonesimulator.app'),
      renameFile('build/Release-iphoneos/multi-touch-draw.app', 'build/Release-iphoneos/multi-touch-draw-iphoneos.app')
    ];
